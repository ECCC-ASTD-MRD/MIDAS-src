...
echo "... loading /home/sssm400/data/ords/fs/ssm/eccc/cmd/cmda/libs/20250604-beta/${COMP_ARCH}"
. ssmuse-sh -x /home/sssm400/data/ords/fs/ssm/eccc/cmd/cmda/libs/20250604-beta/${COMP_ARCH}
