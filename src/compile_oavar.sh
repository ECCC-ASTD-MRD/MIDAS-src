...
if [ "${mode}" == full ] ; then
  ...
  SRC0="tovs_extrap_mod.ftn90 utilities_mod.ftn90 ramdisk_mod.ftn90 toplevelcontrol_mod.ftn90 randomnumber_mod.ftn90"
  ...
  SRC1="$SRC1 bmatrixchem_mod.ftn90 localizationspectral_mod.ftn90 localization_mod.ftn90 bmatrixensemble_mod.ftn90 bmatrixhi_mod.ftn90 lambmatrixhi_mod.ftn90"
