...
if [ "${mode}" == full ] ; then
  ...
  SRC1="$SRC1 bmatrixchem_mod.f90 localizationspectral_mod.f90 localization_mod.f90 bmatrixensemble_mod.f90 bmatrixhi_mod.f90 bmatrixlatbands_mod.f90 lambmatrixhi_mod.f90"
