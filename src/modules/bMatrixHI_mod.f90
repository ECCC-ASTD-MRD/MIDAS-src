...
CONTAINS
  ...
  SUBROUTINE BHI_SUCORNS2
    ...
    call mmpi_allReduce(corns_temp, corns, mmpi_sum)
  ...
  SUBROUTINE BHI_SUTG
    ...
    call mmpi_allReduce(my_zsp_mpiglobal, zsp_mpiglobal, mmpi_sum)
...
!          call utl_abort('bmatrixhi_mod: copyToStatevector: No covariances available for variable:' // vnl_varNameList(jvar))
  ...
  SUBROUTINE BHI_reduceToMPILocal(cv_mpilocal,cv_mpiglobal)
    ...
    call mmpi_allReduce(cvDim_mpilocal, cvDim_maxmpilocal, mmpi_max)
