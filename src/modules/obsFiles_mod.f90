...
contains
  ...
  subroutine obsf_setupFileNames()
    ...
    namePrefix(11)  = 'obstov'
    namePrefix(12)  = 'brpssmis'
    namePrefix(13)  = 'obsssmis'
    namePrefix(14)  = 'brpairs'
    namePrefix(15)  = 'obsairs'
    namePrefix(16)  = 'brpto_amsua'
    namePrefix(17)  = 'obsto_amsua'
    namePrefix(18)  = 'brpto_amsua_allsky'
    namePrefix(19)  = 'obsto_amsua_allsky' 
    namePrefix(20)  = 'brpto_amsub'
    namePrefix(21)  = 'obsto_amsub'
    namePrefix(22)  = 'brpto_amsub_allsky'
    namePrefix(23)  = 'obsto_amsub_allsky'
    namePrefix(24)  = 'brpcsr'
    namePrefix(25)  = 'obscsr'
    namePrefix(26)  = 'brpiasi'
    namePrefix(27)  = 'obsiasi'
    namePrefix(28)  = 'brpatms'
    namePrefix(29)  = 'obsatms'
    namePrefix(30)  = 'brpatms_allsky'
    namePrefix(31)  = 'obsatms_allsky'
    namePrefix(32)  = 'brpcris'
    namePrefix(33)  = 'obscris'
    namePrefix(34)  = 'brpcrisfsr'
    namePrefix(35)  = 'obscrisfsr'
    namePrefix(36)  = 'brpcrisfsr1'
    namePrefix(37)  = 'obscrisfsr1'
    namePrefix(38)  = 'brpcrisfsr2'
    namePrefix(39)  = 'obscrisfsr2'
    namePrefix(40)  = 'brpcrisfsr3'
    namePrefix(41)  = 'obscrisfsr3'
    namePrefix(42)  = 'brpcrisfsr4'
    namePrefix(43)  = 'obscrisfsr4'
    namePrefix(44)  = 'obsmwhs2'
    namePrefix(45)  = 'brpmwhs2'
    namePrefix(46)  = 'brpsw'
