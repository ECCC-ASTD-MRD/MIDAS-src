...
CONTAINS
  ...
  SUBROUTINE BHI_SUTG
    ...
    elseif(clgrtyp == 'G' .and. ni_l == ini .and. nj_l == inj .and. ig1 ==   &
       ...
       ierr = utl_ezsint(tgstdbg,dltg,ni_l,nj_l,1,ini,inj,1)
...
!$OMP END PARALLEL DO
  ...
  SUBROUTINE BHI_reduceToMPILocal_r4(cv_mpilocal,cv_mpiglobal,cvDim_mpilocal_out)
    implicit none
...
!$OMP END PARALLEL DO
  ...
  SUBROUTINE BHI_expandToMPIGlobal_r4(cv_mpilocal,cv_mpiglobal,cvDim_mpiglobal_out)
    implicit none
