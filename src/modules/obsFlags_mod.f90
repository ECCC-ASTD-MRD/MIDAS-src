...
module obsFlags_mod
  ...
  ! Variables for each possible bitNumber value
  integer, public, parameter :: flg_offset = 1000
  ...
  integer, public, parameter :: flg_10           = 10 + flg_offset
  ...
  character(len=35) :: flg_descrip(minBitValue:maxBitValue)
  data flg_descrip/'DATA MODIFIED OR GEN BY ADE       ', & ! 00
