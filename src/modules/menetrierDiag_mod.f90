...
contains
  ...
  subroutine calcHorizLocalizationRadii(ensPerts,stride,waveBandIndex_opt)
    ...
    call mmpi_reduce(sumWeight_local,            sumWeight,            mmpi_sum)
    call mmpi_reduce(meanCorrel_local,           meanCorrel ,          mmpi_sum)
    call mmpi_reduce(meanCorrelSquare_local,     meanCorrelSquare,     mmpi_sum)
    call mmpi_reduce(meanVarianceProduct_local,  meanVarianceProduct,  mmpi_sum)
    call mmpi_reduce(meanFourthMoment_local,     meanFourthMoment,     mmpi_sum)
    call mmpi_reduce(meanCovarianceSquare_local, meanCovarianceSquare, mmpi_sum)
