...
contains
  ...
  subroutine obsf_setupFileNames()
    ...
    clvalu(18) = 'brpatms'
    clvalu(19) = 'brpcris'
    clvalu(20) = 'brpcrisfsr'
    clvalu(21) = 'brpcrisfsr1'
    clvalu(22) = 'brpcrisfsr2'
    clvalu(23) = 'brpcrisfsr3'
    clvalu(24) = 'brpcrisfsr4'
    clvalu(25) = 'brpsw'
    clvalu(26) = 'brpswgoes9'
    clvalu(27) = 'brpswgoese'
    clvalu(28) = 'brpswgoesw'
    clvalu(29) = 'brpswmodis'
    clvalu(30) = 'brpswmtsate'
    clvalu(31) = 'brpswmtsatw'
    clvalu(32) = 'brpgo'
    clvalu(33) = 'brpsc'
    clvalu(34) = 'brppr'
    clvalu(35) = 'brpro'
    ...
    clvalu(53) = 'obsssmis'
    clvalu(54) = 'obsairs'
    clvalu(55) = 'obsto_amsua'
    clvalu(56) = 'obsto_amsua_allsky'
    clvalu(57) = 'obsto_amsub'
    clvalu(58) = 'obscsr'
    clvalu(59) = 'obsiasi'
    clvalu(60) = 'obsatms'
    clvalu(61) = 'obscris'
    clvalu(62) = 'obscrisfsr'
    clvalu(63) = 'obscrisfsr1'
    clvalu(64) = 'obscrisfsr2'
    clvalu(65) = 'obscrisfsr3'
    clvalu(66) = 'obscrisfsr4'
    clvalu(67) = 'obssw'
    clvalu(68) = 'obsswgoes9'
    clvalu(69) = 'obsswgoese'
    clvalu(70) = 'obsswgoesw'
    clvalu(71) = 'obsswmodis'
    clvalu(72) = 'obsswmtsate'
    clvalu(73) = 'obsswmtsatw'
    clvalu(74) = 'obsgo'
    clvalu(75) = 'obssc'
    clvalu(76) = 'obspr'
    clvalu(77) = 'obsro'
    ...
    clvalu(81) = 'obsgp'
    clvalu(82) = 'obsch'
    clvalu(83) = 'obsgl_ssmi'
    clvalu(84) = 'obsgl_ssmis'
    clvalu(85) = 'obsgl_amsr2'
    clvalu(86) = 'obsgl_ascat'
    clvalu(87) = 'obsgl_avhrr'
    clvalu(88) = 'obsgl_cisA'
    clvalu(89) = 'obsgl_cisI'
    clvalu(90) = 'obsgl_cisL'
    clvalu(91) = 'obsgl_cisR'
    clvalu(92) = 'cmaheader' ! file name for CMA format used by EnKF
    clvalu(93) = 'brpsst'
    clvalu(94) = 'obsal'
    clvalu(95) = 'obsradar'
    clvalu(96) = 'obssst'
    ...
    cfami(90)  = 'GL'
    cfami(91)  = 'GL'
    cfami(92)  = 'XX' ! dummy family type for CMA, since it contains all families
    cfami(93)  = 'TM'
    cfami(94)  = 'AL'
    cfami(95)  = 'RA'
    cfami(96)  = 'TM'
