...
contains
  ...
  subroutine obsf_setupFileNames()
    ...
    clvalu(21) = 'brpsw'
    clvalu(22) = 'brpswgoes9'
    clvalu(23) = 'brpswgoese'
    clvalu(24) = 'brpswgoesw'
    clvalu(25) = 'brpswmodis'
    clvalu(26) = 'brpswmtsate'
    clvalu(27) = 'brpswmtsatw'
    clvalu(28) = 'brpgo'
    clvalu(29) = 'brpsc'
    clvalu(30) = 'brppr'
    clvalu(31) = 'brpro'
    ...
    clvalu(49) = 'obsssmis'
    clvalu(50) = 'obsairs'
    clvalu(51) = 'obsto_amsua'
    clvalu(52) = 'obsto_amsub'
    clvalu(53) = 'obscsr'
    clvalu(54) = 'obsiasi'
    clvalu(55) = 'obsatms'
    clvalu(56) = 'obscris'
    clvalu(57) = 'obscrisfsr1'
    clvalu(58) = 'obscrisfsr2'
    clvalu(59) = 'obssw'
    clvalu(60) = 'obsswgoes9'
    clvalu(61) = 'obsswgoese'
    clvalu(62) = 'obsswgoesw'
    clvalu(63) = 'obsswmodis'
    clvalu(64) = 'obsswmtsate'
    clvalu(65) = 'obsswmtsatw'
    clvalu(66) = 'obsgo'
    clvalu(67) = 'obssc'
    clvalu(68) = 'obspr'
    clvalu(69) = 'obsro'
