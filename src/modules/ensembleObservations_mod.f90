...
CONTAINS
  ...
  subroutine eob_allGather(ensObs,ensObs_mpiglobal)
    ...
    call mmpi_gatherv(ensObsClean%varNum,       ensObs_mpiglobal%varNum,       allNumObs, displs, ensObsClean%numObs)
    call mmpi_gatherv(ensObsClean%channel,      ensObs_mpiglobal%channel,      allNumObs, displs, ensObsClean%numObs)
    ...
    call mmpi_bcast(ensObs_mpiglobal%varNum,  ensObs_mpiglobal%numObs)
    call mmpi_bcast(ensObs_mpiglobal%channel, ensObs_mpiglobal%numObs)
