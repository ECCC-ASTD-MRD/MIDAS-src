...
!    call removeBalancedChi(ensPerturbations,theta2)
  ...
  subroutine calcCorrelations(ensPerturbations,corns,rstddev,latMask_opt, &
    ...
    integer :: ensIndex,ila_mpilocal,ila_mpiglobal,jn,jm,jk1,jk2,latIndex,nsize
    ...
    call mmpi_allReduce(corns, corns_mpiglobal, "mpi_sum", nsize)
  ...
  subroutine calcCorrelations2(ensPerts,corns,rstddev,latMask_opt)
    ...
    integer :: levIndex, latIndex, nsize
  ...
  subroutine calcTheta(ensPerturbations,theta)
    ...
    real(4), pointer :: psi_ptr(:,:,:), chi_ptr(:,:,:)
    integer :: latIndex,lonIndex,levIndex,ensIndex, nsize
    ...
    nsize = nLevEns_M*nj
    call mmpi_allReduce(zchipsi, zchipsi_mpiglobal, "mpi_sum", nsize)
    call mmpi_allReduce(zpsipsi, zpsipsi_mpiglobal, "mpi_sum", nsize)
  ...
  subroutine calcPtoT(ensPerturbations,PtoT)
    ...
    call mmpi_allReduce(zm1, zm1_mpiglobal, "mpi_sum", nsize)
    nsize = NLEVPTOT*NLEVPTOT*JPNLATBND
    call mmpi_allReduce(zm2, zm2_mpiglobal, "mpi_sum", nsize)
  ...
  subroutine calcZonAvg(fieldsZonAvg_mpiglobal,fields3D,nlev)
    ...
    ! Locals:
    integer :: lonIndex, latIndex, levIndex, nsize
    real(8) :: dfact
    ...
    nsize = nlev*nj
    call mmpi_allReduce(fieldsZonAvg, fieldsZonAvg_mpiglobal, "mpi_sum", nsize)
  ...
  subroutine calcBalancedP(sppsi,spgz)
    ...
    call mmpi_allReduce(spvor_mpiglobal, spvor_mpiglobal2, "mpi_sum", nsize)
