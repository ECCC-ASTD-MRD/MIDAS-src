...
eval $(cclargs_lite                                                  \
 ...
 -src_dir   ${defautSrcDir} ${defautSrcDir} "[ source code directory (default: result of '\$(${toplevelCmd})/src')]" \
...
if [[ "${web_dir}" = ${HOME}/public_html/* ]]; then
    typeset -r url=${web_dir/${HOME}\/public_html/https:\/\/goc-dx-u3.science.gc.ca\/~${USER}}
