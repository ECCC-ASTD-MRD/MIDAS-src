...
## 'MIDAS_CODECOVERAGE_DATAPATH' as a directory to find the
...
typeset -r defautCovDir=${MIDAS_CODECOVERAGE_DATAPATH:-}
...
eval `cclargs_lite                                                  \
 -cov_dir   ${defautCovDir} ${defautCovDir} "[code coverage directory for files generated by the execution (default: value of env variable 'MIDAS_CODECOVERAGE_DATAPATH']"      \
