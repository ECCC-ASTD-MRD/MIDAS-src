...
SRC_FILES="rttov_interfaces_mod.ftn90 clib_interfaces_mod.ftn90 codeprecision_mod.ftn90 utilities_mod.f90 ramdisk_mod.f90 filenames_mod.f90 randomnumber_mod.f90"
...
SRC_FILES="$SRC_FILES lamspectraltransform_mod.f90 gridstatevector_mod.f90 humiditylimits_mod.f90 ensemblestatevector_mod.f90 statetocolumn_mod.f90 variabletransforms_mod.f90 advection_mod.f90"
...
SRC_FILES="$SRC_FILES obssubspacedata_mod.f90 burpfiles_mod.f90 sqlitefiles_mod.f90 cmafiles_mod.f90 obsfiles_mod.f90 multi_ir_bgck_mod.f90 chem_setup_mod.f90 chem_obserrors_mod.f90"
