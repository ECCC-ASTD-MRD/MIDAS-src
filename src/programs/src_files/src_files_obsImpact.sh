...
SRC_FILES="$SRC_FILES obssubspacedata_mod.f90 burpfiles_mod.f90 cmafiles_mod.f90 obsfiles_mod.f90 multi_ir_bgck_mod.f90 chem_setup_mod.f90 chem_obserrors_mod.f90"
