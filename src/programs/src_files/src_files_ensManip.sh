...
LIBAPPL="rttov_coef_io rttov_hdf rttov_parallel  rttov_main rttov_emis_atlas rttov_other ${HDF5_LIBS} burp_module vgrid irc $MPILIB"

SRC_FILES="codeprecision_mod.ftn90 clib_interfaces_mod.ftn90 utilities_mod.f90 bufr_mod.f90 ramdisk_mod.f90 filenames_mod.f90"
