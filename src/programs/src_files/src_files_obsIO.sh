...
LIBAPPL="burp_module vgrid irc $MPILIB f90sqlite udfsqlite"
...
SRC_FILES="$SRC_FILES codeprecision_mod.ftn90 obsspacedata_mod.f90 obssubspacedata_mod.f90 obsUtil_mod.f90 kdtree2_mod.f90"
