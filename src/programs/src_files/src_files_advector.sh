...
SRC_FILES="clib_interfaces_mod.ftn90 codeprecision_mod.f90 utilities_mod.f90 ramdisk_mod.f90 bufr_mod.f90"
...
SRC_FILES="$SRC_FILES gridstatevector_mod.f90 humiditylimits_mod.f90 ensemblestatevector_mod.f90 advection_mod.f90"
