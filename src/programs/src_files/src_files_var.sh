...
SRC_FILES="$SRC_FILES tovs_extrap_mod.f90 controlvector_mod.f90 rmatrix_mod.f90 hirchannels_mod.f90 "
...
SRC_FILES="$SRC_FILES burpread_mod.f90"
SRC_FILES="$SRC_FILES gps_mod.f90"
SRC_FILES="$SRC_FILES obssubspacedata_mod.f90 burpfiles_mod.f90 cmafiles_mod.f90 obsfiles_mod.f90 multi_ir_bgck_mod.f90"
