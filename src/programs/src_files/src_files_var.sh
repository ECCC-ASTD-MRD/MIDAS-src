...
SRC_FILES="$SRC_FILES lamspectraltransform_mod.f90 gridstatevector_mod.f90 ensemblestatevector_mod.f90 statetocolumn_mod.f90 variabletransforms_mod.f90 humiditylimits_mod.f90 addincrement_mod.f90"
...
SRC_FILES="$SRC_FILES obssubspacedata_mod.f90 burpfiles_mod.f90 multi_ir_bgck_mod.f90 chem_setup_mod.f90 chem_obserrors_mod.f90"
