...
SRC_FILES="$SRC_FILES ensemblestatevector_mod.f90 advection_mod.f90 localizationfunction_mod.f90 localizationspectral_mod.f90 localization_mod.f90 spectralfilter_mod.f90"
...
SRC_FILES="$SRC_FILES tt2phi_mod.f90 statetocolumn_mod.f90 chem_setup_mod.f90 chem_postproc_mod.f90 humiditylimits_mod.f90 increment_mod.f90"
