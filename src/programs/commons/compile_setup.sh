...
if [ "${ORDENV_PLAT}" = ubuntu-14.04-amd64-64 -o "${ORDENV_PLAT}" = sles-11-amd64-64 -o "${ORDENV_PLAT}" = sles-11-broadwell-64-xc40 ]; then
    ...
    echo "... loading /home/erv000/data/ords/SSM/rttov-12/hugepages16m-1.5-1-g6f34544/${COMP_ARCH}"
    . r.load.dot /home/erv000/data/ords/SSM/rttov-12/hugepages16m-1.5-1-g6f34544/${COMP_ARCH}
