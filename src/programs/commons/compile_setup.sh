...
if [ "${ORDENV_PLAT}" = ubuntu-14.04-amd64-64 ];then
    ...
    ## for rmn, rpncomm
    echo "... loading eccc/mrd/rpn/libs/19.4"
    . r.load.dot eccc/mrd/rpn/libs/19.4
    ## for openmpi
...
if [ "${ORDENV_PLAT}" = ubuntu-14.04-amd64-64 -o "${ORDENV_PLAT}" = sles-11-amd64-64 -o "${ORDENV_PLAT}" = sles-11-broadwell-64-xc40 ]; then
    ...
    ## for 'vgrid'
    echo "... loading eccc/mrd/rpn/vgrid/6.4.4"
    . ssmuse-sh -d eccc/mrd/rpn/vgrid/6.4.4

    echo "... loading eccc/cmd/cmda/libs/19.4/${COMP_ARCH}"
    . ssmuse-sh -d eccc/cmd/cmda/libs/19.4/${COMP_ARCH}
