...
contains
  ...
  subroutine fso_ensemble(columnTrlOnAnlIncLev,obsSpaceData)
    ...
    ! for statevector_VeriA (include reading verifying analysis)
  ...
  subroutine fso_calcFcstError(columnTrlOnAnlIncLev,statevector_a,statevector_out)
    !
    ...
    character(len=256)              :: fileName_fa, fileName_fb
    logical                         :: faExists
...
>>>>>>> 06e34ef3... Issue #179:change the place of reading verifying analysis from fso_calcFcstError to fso_ensemble
