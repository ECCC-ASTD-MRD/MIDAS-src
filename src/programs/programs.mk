...
adjointTest.Abs: LIBAPPL = f90sqlite udfsqlite rttov_coef_io\
		rttov_hdf rttov_parallel rttov_main rttov_emis_atlas rttov_other rttov_mw_scatt \
...
analysisErrorOI.Abs: LIBAPPL = f90sqlite udfsqlite rttov_coef_io rttov_hdf\
                rttov_parallel rttov_main rttov_emis_atlas rttov_other rttov_mw_scatt \
                $(HDF5_LIBS) burp_module $(VGRID_LIBNAME) irc $(MPILIB) random
...
ensembleH.Abs: LIBAPPL = rttov_coef_io rttov_hdf rttov_parallel\
		rttov_main rttov_emis_atlas rttov_other rttov_mw_scatt  $(HDF5_LIBS) burp_module\
...
letkf.Abs: LIBAPPL = rttov_coef_io rttov_hdf rttov_parallel rttov_main\
		rttov_emis_atlas rttov_other rttov_mw_scatt  $(HDF5_LIBS) burp_module $(VGRID_LIBNAME)\
...
prepcma.Abs: LIBAPPL = rttov_coef_io rttov_hdf rttov_parallel\
		rttov_main rttov_emis_atlas rttov_other rttov_mw_scatt  $(HDF5_LIBS) f90sqlite\
