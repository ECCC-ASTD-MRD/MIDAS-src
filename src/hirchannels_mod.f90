...
Module hirchannels_mod
  ...
  REAL (8),parameter  :: CRISSWN_LW(1:713)=(/(650.0_8 + (i-1)*0.625_8,i=1,713) /)
  REAL (8),parameter  :: CRISSWN_MW(714:1146)=(/(1210.0_8 + (i-714)*1.25_8,i=714,1146) /)
  REAL (8),parameter  :: CRISSWN_SW(1147:1305)=(/(2155.0_8 + (i-1147)*2.50_8,i=1147,1305) /)


  REAL (8)  :: CRISSWN(CRISSNCH) = (/CRISSWN_LW,CRISSWN_MW,CRISSWN_SW /)
...
contains
  ...
  integer function hir_get_nchan_all(CINST)
    implicit none
    character (len=*),intent(in) :: CINST
    ...
    case default
       Write(*,*) "Unknown instrument! ",CINST
       call utl_abort("hir_get_nchan_all from  hirchannels module")
    end select

  end function hir_get_nchan_all


  real(8) function hir_get_wavn(CINST,ICHAN)
    implicit none
    character (len=*),intent(in) :: CINST
    ...
    if (ichan<1) then
       ...
       call utl_abort("hir_get_wavn from  hirchannels module")
    endif
