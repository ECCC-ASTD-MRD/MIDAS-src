...
!-------------------------------------------------------------------------------------------
    ...
    if (cvm_subVectorExists(cvm_BHI).or. cvm_subVectorExists(cvm_BCHM)) then
    ...
    FAMILY: do familyIndex = 1, numFamily
      ...
      ELEMENT: do elementIndex = 1, numElement  
        ...
        if (familyList(familyIndex).ne.'CH') then
           if (cvm_subVectorExists(cvm_BHI)) lpert_static=.true.
        else        
           if (cvm_subVectorExists(cvm_BCHM)) lpert_static=.true.
        end if
        if (cvm_subVectorExists(cvm_BEN)) lpert_ens=.true.
