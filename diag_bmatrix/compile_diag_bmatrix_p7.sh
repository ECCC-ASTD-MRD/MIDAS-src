...
trunkfiles="abort.ftn bmatrix_mod.ftn90 bmatrixensemble_mod.ftn90 bmatrixhi_mod.ftn90 \
            columndata_mod.ftn90 comfilt.cdk controlvector_mod.ftn90 \
            gasdev.ftn gaussgrid_mod.ftn90 gdout2.ftn getfldprm2.ftn \
...
cp -f modulopt/${moduloptfiles} ${compiledir}
...
s.compile -O -abi $ABI $COMPF $INCLUDES -libpriv -libpath $LIBPATH2 -libappl $LIBAPPL $LIBEXTRA -libsys $LIBSYS -librmn $LIBRMN -obj *.o -o diag_bmatrix_p7.abs$ABSTAG > listing5 2>&1
