...
if [ "${mode}" == full ] ; then
  ...
  SRC1="$SRC1 varnamelist_mod.ftn90 columndata_mod.ftn90 ozoneclim_mod.ftn90 tovs_extrap_mod.ftn90 tovs_nl_mod.ftn90 multi_ir_bgck_mod.ftn90"
  SRC1="$SRC1 globalspectraltransform_mod.ftn90 tt2phi_mod.ftn90"
  SRC1="$SRC1 lamspectraltransform_mod.ftn90 gridstatevector_mod.ftn90 ensemblestatevector_mod.ftn90 statetocolumn_mod.ftn90 variabletransforms_mod.ftn90"
  ...
  SRC2="obssubspacedata_mod.ftn90 burpfiles_mod.ftn90 chem_obserrors_mod.ftn90 obserrors_mod.ftn90 varqc_mod.ftn90 chem_setup_mod.ftn90 obsfilter_mod.ftn90 tovs_lin_mod.ftn90 chem_obsoperators_mod.ftn90 obsoperators_mod.ftn90 obsspacediag_mod.ftn90  innovation_mod.ftn90"
