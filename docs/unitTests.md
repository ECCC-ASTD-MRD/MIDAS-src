...
```bash
export MIDAS_CODECOVERAGE_DATAPATH='an absolute path where the code coverage data can be saved'
```
 ...
 *** SEQUENCE D'APPEL ***
 ...
 [positionnels]
 IN       -cov_dir [:] code coverage directory for files generated by the execution (default: value of env variable 'MIDAS_CODECOVERAGE_DATAPATH'
