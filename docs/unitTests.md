 ...
 *** SEQUENCE D'APPEL ***
 ...
 [positionnels]
 IN       -cov_dir [${PWD}/../compiledir/code-coverage:${PWD}/../compiledir/code-coverage] code coverage directory for files generated by the execution (default: value of env variable 'MIDAS_COMPILE_ADD_CODECOVERAGE_OPTIONS'
