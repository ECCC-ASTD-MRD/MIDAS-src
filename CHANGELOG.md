 ...
 * Introduction of RTTOV built-in IR land emissivity atlases. Deleted `useUofWIREmiss`, added `oldFashionIRLandEmiss`, `irEmissAngularCorrection` and `useWaterFraction` logicals to `NAMTOV` namelist section (#1001 and !916)
